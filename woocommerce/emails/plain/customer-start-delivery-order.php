...
echo sprintf( esc_html__( 'Just to let you know &mdash; the delivery for your order #%s has been started.', 'lddfw' ), esc_html( $order->get_order_number() ) ) . "\n\n";
...
if ( '' !== get_option( 'lddfw_tracking_page', '' ) ) {
	...
	if ( '' !== $tracking_url ) {
		echo esc_html__( 'Track your order', 'lddfw' ) . ":\n";
		echo $tracking_url . "\n\n";
	}
}
